...
def generiere_feedback_von_ollama(buchung, nutzeraufgabe, beschreibung, aufgabeninfo):
    ...
    prompt = (
        ...
        f"Sachverhalt: \n{beschreibung}\n"
        f"Zusatzinformationen:\n Falls die Aufgabe einen Bezug zu anderen Aufgaben hat bzw. anderweitig Informationen relevant sind, stehen diese hier, ansonsten ignoriere diese Zeile: {aufgabeninfo}\n"
